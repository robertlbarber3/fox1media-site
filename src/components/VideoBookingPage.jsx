...
import styles from './BookingPage.module.css'; // reuse identical styles

// ─── Google Calendar Config (same as photo booking) ───────────────────────────
const GOOGLE_API_KEY     = '0cba6dc6994f1899a4597b5c05448666be14bfba';
const GOOGLE_CALENDAR_ID = 'robert@fox1media.com';

// ─── Session options ──────────────────────────────────────────────────────────
const SESSIONS = [
  { hours: 2, price: 80,  label: '2 HRS' },
  { hours: 3, price: 100, label: '3 HRS' },
  { hours: 4, price: 120, label: '4 HRS' },
];
...
export default function VideoBookingPage({ onNavigate, cart = [], addToCart }) {
    ...
    try {
      const res = await fetch(
        `https://www.googleapis.com/calendar/v3/freeBusy?key=${GOOGLE_API_KEY}`,
        {
          ...
          body: JSON.stringify({ timeMin, timeMax, items: [{ id: GOOGLE_CALENDAR_ID }] }),
        }
      );
  ...
  function isBusy(day)     { return busyDates.has(dateKey(calYear, calMonth, day)); }
  ...
  function isToday(day) {
    return today.getFullYear() === calYear &&
      ...
      <main className={styles.main}>
        ...
        <div className={styles.titleRow}>
          <div className={styles.eyebrow}>
            ...
            Video Session Booking // Select Your Package
          </div>
          <h1 className={styles.heading}>
            Book Your <span className={styles.accent}>Shoot.</span>
          </h1>
        </div>
        ...
        <div className={styles.stepBlock}>
          ...
          <div className={styles.sessionGrid} style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
            {SESSIONS.map((s) => (
              <button
                key={s.hours}
              ...
              >
                ...
                <div className={styles.sessionPhotos}>CINEMATIC</div>
                <div className={styles.sessionIncluded}>FOOTAGE</div>
          ...
          <div className={styles.photoNote}>
            <span className={styles.noteAccent}>//</span> All sessions include <strong>stabilized rolling footage</strong>, social-ready cuts, and a <strong>full-length edit</strong>.
            Custom deliverable packages available — mention it in your booking notes.
          </div>
        </div>
          ...
          <div className={styles.stepBlock}>
            ...
            <div className={styles.calendarWrap}>
              ...
              <div className={styles.calHeader}>
                <button className={styles.calNav} onClick={prevMonth} disabled={atMinMonth}>&#8249;</button>
                <div className={styles.calMonthLabel}>{MONTHS[calMonth]} {calYear}</div>
              ...
              <div className={styles.calLegend}>
                <div className={styles.legendItem}><span className={styles.legendDotAvail} /> AVAILABLE</div>
                <div className={styles.legendItem}><span className={styles.legendDotBusy} /> BOOKED</div>
                <div className={styles.legendItem}><span className={styles.legendDotSel} /> SELECTED</div>
              </div>
          ...
          <div className={styles.stepBlock}>
            ...
            <div className={styles.summaryBar}>
              ...
              <div className={styles.summaryItem}>
                ...
                <span className={styles.summaryVal}>VIDEOGRAPHY</span>
              </div>
              <div className={styles.summaryDivider} />
              <div className={styles.summaryItem}>
              ...
              <div className={styles.summaryItem}>
                ...
                <span className={`${styles.summaryVal} ${styles.summaryPrice}`}>${selectedSession.price}</span>
              </div>
            </div>
          </div>
        )}
          ...
          <div className={styles.stepBlock}>
            ...
            <div className={styles.upsellBlock}>
              ...
              <p className={styles.upsellSub}>
                // You can bundle a photo session, custom merch, or any other service
